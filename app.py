...
data_enf=data.rename(columns={'Cancer': 'Cáncer', 'Hta': 'Hipertensión','Cardiopatia':'Cardiopatía','Ecv':'Cerebrovascular','Hipotiroidismo':'Tiroides','Epoc':'PulmonarObstructiva','EnfermedadRenal':'Renal','Vih':'VIH','ExpHumoDeLenia':'ExposiciónLeña','EnEstudio':'En Estudio','OxigenoRequirente':'OxígenoRequirente','HtPulmonar':'Pulmonar','Cistostomia':'Cistostomía','Neumonia':'Neumonía','Depresion':'Depresión','Civ':'Cardiopatía','Desnutricion':'Desnutrición','CirrosisHepatica':'CirrosisHepática','Sifilis':'Sífilis','FibrosisPulmonar':'Pulmonar','EnfermedadPulmonar':'Pulmonar','Ehi':'Encefalopatía','Hepatopatia':'Hepatopatía','Ela':'Esclerosis','Polineuropatia':'Neuropatía','Pti':'Púrpura','Cch':'Cistoadenoma','Hbp':'Hiperplasia','Pad':'EnfermedadArterial','EnfermedadAutoinmune':'Autoinmune','Fq':'FibrosisQuística','Eh':'Huntington','Trm':'TraumaRaquimedular','Tce':'TraumaCraneoencefálico','Gf':'Gangrena','Sii':'IntestinoIrritable','Migrania':'Migraña','Sahs':'ApneaDelSueño','Eu':'Encefalopatía','Smd':'SindromeMielodisplásico','Mg':'MiasteniaGravis'})
